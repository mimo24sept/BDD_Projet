...
export const dom = {
  ...
  passwordMenu: document.querySelector('#password-menu'),
  passwordToggleBtn: document.querySelector('#password-toggle'),
  passwordPanel: document.querySelector('#password-panel'),
  passwordForm: document.querySelector('#password-form'),
  passwordMsg: document.querySelector('#password-msg'),
  passwordInputs: {
    current: document.querySelector('#password-current'),
    next: document.querySelector('#password-next'),
    confirm: document.querySelector('#password-confirm'),
  },
  ...
  adminInputs: {
    ...
    datasheetUrl: document.querySelector('#admin-datasheet-url'),
    datasheetFile: document.querySelector('#admin-datasheet-file'),
  },
